...
42. En exécutant le parallel workflow, tous les workflows s'exécutent en asynchrone.
44. La pipeline créée semble assez complète et permet un large panel de vérifications et de setup du projet.